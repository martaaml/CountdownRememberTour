// Fecha objetivo
const fechaObjetivo = new Date("Apr 10, 2025 21:00:00").getTime();
...
const intervalo = setInterval(() => {
  ...
  if (diferencia <= 0) {
   ...
   //Si la fecha ha pasado, muestra mensaje de "Ya ha finalizado"
  if (diferencia <= 0) {
    document.getElementById("cuentaAtras").innerHTML = "¡Ya ha finalizado!";
    return;
  }
